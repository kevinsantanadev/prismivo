-- Marco 11 — rate limiting persistente para fluxos sensíveis de autenticação.
...
create index rate_limit_windows_expiry_idx on private.rate_limit_windows(expires_at);
