...
export function ProjectForm({ locale = "pt-BR" }: { locale?: SiteLocale }) {
  ...
  return (
    <div className="quick-project" id="novo-projeto">
      <button className="app-primary-button" type="button" onClick={() => setOpen((value) => !value)} aria-expanded={open} aria-controls="project-form-panel"><Plus aria-hidden="true" />{copy.projectForm.newProject}</button>
